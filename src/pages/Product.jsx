        ...
        <div className="lg:col-span-7">
          <div className="relative aspect-[3/4] w-full bg-surface-muted rounded-lg overflow-hidden group">
            ...
            <button
              ...
              className={`absolute top-4 right-4 w-11 h-11 rounded-full backdrop-blur-sm flex items-center justify-center border transition-colors ${
                faves.has(product.id)
